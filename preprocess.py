...
def do_format_to_bert(args):
    print(time.clock())
    data_builder2.format_to_bert(args)
    print(time.clock())
...
if __name__ == '__main__':
    ...
    parser.add_argument("-shard_size", default=1999, type=int)
    ...
    # parser.add_argument('-max_tgt_ntokens', default=30, type=int)
    ...
    eval('data_builder2.'+args.mode + '(args)')
