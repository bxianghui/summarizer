...
class Trainer(object):
    ...
    def validate(self, valid_iter, step=0):
        ...
        with torch.no_grad():
            for batch in valid_iter:
                ...
                outputs, _, copy_prob = self.model(src, tgt, segs, mask_src, mask_tgt, z, mask_z, z_segs, src_txt)
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            # outputs, scores, copy_prob = self.model(src, tgt, segs, mask_src, mask_tgt, z, mask_z, z_segs)
            outputs, scores, copy_prob = self.model(src, tgt, segs, mask_src, mask_tgt, z, mask_z, z_segs, src_txt)
